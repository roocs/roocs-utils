from roocs_utils.project_utils import get_project_name, get_project_base_dir
...
def test_get_project_name():
    ...
    dset = "tests/mini-esgf-data/test_data/badc/cmip5/data/cmip5/output1/MOHC/HadGEM2-ES/rcp85/mon/atmos" \
    ...
    ds = xr.open_mfdataset("tests/mini-esgf-data/test_data/badc/cmip5/data/cmip5/output1/MOHC/HadGEM2-ES/historical"
                           "/mon/atmos/Amon/r1i1p1/latest/tas/*.nc", use_cftime=True, combine='by_coords')
    project = get_project_name(ds)
    assert project == "cmip5"

    ds = xr.open_mfdataset("tests/mini-esgf-data/test_data/badc/cmip6/data/CMIP6/CMIP/NCAR/CESM2/historical/r1i1p1f1"
                           "/SImon/siconc/gn/latest/*.nc", use_cftime=True, combine='by_coords')
    project = get_project_name(ds)
    assert project == "cmip6"
